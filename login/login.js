...
angular.module('xcloud.login', ['ngRoute'])
    ...
    .controller('LoginController', ['$scope', '$window', 'config', function($scope, $window, config) {
        localStorage.removeItem("auth");
        console.log(config.xcloud_url);

        $scope.hide_signout = true;
        ...
        $scope.login = function(){
            ...
            $.ajax({
                type: "GET",
                url: config.xcloud_url + "/xcloud/auth",
